...
0. **Dev Container में खोलें (अनुशंसित):** रेपो क्लोन करने के बाद इसे VS Code में खोलें और "Reopen in Container" चलाएँ ताकि आप प्रदत्त `.devcontainer` वातावरण में ही विकास करें। इससे बिना अतिरिक्त मैनुअल सेटअप के सही Node.js और pnpm संस्करण उपलब्ध रहते हैं।
