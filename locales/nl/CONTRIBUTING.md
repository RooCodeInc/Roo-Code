...
- **Primair:** Word lid van onze [Discord](https://discord.tbd) en stuur een DM naar **Hannes Rudolph (`hrudolph`)**.
...
- **Wil je eraan werken?** Reageer met "Claiming" op de issue en stuur een DM naar **Hannes Rudolph (`hrudolph`)** op [Discord](https://discord.tbd) om toegewezen te worden. De toewijzing wordt in de thread bevestigd.
...
- Moet verwijzen naar een toegewezen GitHub Issue. Om toegewezen te worden: reageer met "Claiming" op de issue en stuur een DM naar **Hannes Rudolph (`hrudolph`)** op [Discord](https://discord.tbd). De toewijzing wordt in de thread bevestigd.
