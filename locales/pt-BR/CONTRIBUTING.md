...
- Para documentação, visite [Documentação do Klaus Code](https://github.com/RooCodeInc/Roo-Code-Docs).
...
- Crie um novo bug usando o [modelo "Relatório de bug"](https://github.com/RooCodeInc/Roo-Code/issues/new/choose) com:
    ...
    - Versão do Klaus Code (obrigatório); provedor/modelo de IA, se relevante
...
Ao contribuir, você concorda que suas contribuições serão licenciadas sob a Licença Apache 2.0, consistente com o licenciamento do Klaus Code.
