...
## <a id="_xxuy5kn5r0ry"></a>**The Business Objective**
...
### <a id="_ikynmij68fbp"></a>**Cognitive Debt**
...
## <a id="_6j72lcuj7k58"></a>

## <a id="_uibs3378fyaw"></a>**Mandatory Research & Conceptual Foundation**
...
- **On Intent Formalization**:
    ...
    - [_Formal Intent Theory_](http://sunnyday.mit.edu/papers/intent-tse.pdf)\* _[_ \*](https://github.com/cbora/aispec)
...
## <a id="_b1t54p6a1t4n"></a>**The Architecture Specification**
...
### <a id="_fm1zn8kb9x04"></a>**The Hook Engine & Middleware Boundary**
...
### <a id="_tji2sw511qa6"></a>**The Data Model**
...
"files": \[
    ...
    \{
      ...
      "relative\_path": "src/auth/middleware\.ts",

      "conversations": \[

        \{

          "url": "session\_log\_id",

          "contributor": \{

            "entity\_type": "AI",

            "model\_identifier": "claude\-3\-5\-sonnet"
          ...
          "ranges": \[
            ...
            \{
              ...
              "content\_hash": "sha256:a8f5f167f44f4964e6c998dee827110c"
...
## <a id="_ilfeood0w0ct"></a>

## <a id="_fplto5hfaulf"></a>**Implementation Curriculum **
...
### <a id="_ihuunf8y9opl"></a>**Phase 0: The Archaeological Dig**
...
### <a id="_fvg9txdhwr6v"></a>**Phase 1: The Handshake \(Reasoning Loop Implementation\)**
...
#### <a id="_d5neyami5sjw"></a>**Phase 2: The Hook Middleware & Security Boundary**
...
### <a id="_d4mmbrxa1s6f"></a>**Phase 3: The AI\-Native Git Layer \(Full Traceability\)**
...
### <a id="_j2csfmyxb3ko"></a>**Phase 4: Parallel Orchestration \(The Master Thinker\)**
...
## <a id="_jtmbij8hugfd"></a>**Proof of Execution \(The Demo\)**
...
### <a id="_ahvbrlb0pray"></a>Final Submission \- Saturday 21hr UTC
...
2. **The Meta\-Audit Video:**
    - Demonstrating the workflow defined in Section 5\.
3. Submit a GitHub Repository containing:
...
## <a id="_yrfe6qrbnrt7"></a>**Evaluation Rubric**
