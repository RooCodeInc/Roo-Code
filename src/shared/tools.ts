...
/**
 * select_active_intent tool — Phase 1 "Handshake" tool.
 * Forces the AI agent to declare an active intent ID from .orchestration/active_intents.yaml
 * before performing any mutating operations. The pre-hook intercepts this call,
 * reads the intent context, and injects constraints/scope back into the conversation.
 */
