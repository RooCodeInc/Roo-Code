	...
	*/
	...
	async getStateToPostToWebview(): Promise<ExtensionState> {
		...
		return {
			...
			mcpMaxImagesPerResponse: mcpMaxImagesPerResponse ?? 20,
			mcpMaxImageSizeMB: mcpMaxImageSizeMB ?? 10,
	...
	> {
		...
		return {
			...
			mcpMaxImagesPerResponse: stateValues.mcpMaxImagesPerResponse ?? 20,
			mcpMaxImageSizeMB: stateValues.mcpMaxImageSizeMB ?? 10,
