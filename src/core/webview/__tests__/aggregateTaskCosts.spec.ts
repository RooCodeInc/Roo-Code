...
describe("getDisplayCosts", () => {
	it("should return correct format for task with no children", async () => {
		const mockHistory: Record<string, HistoryItem> = {
			"task-1": {
				id: "task-1",
				totalCost: 1.5,
	...
	it("should return correct format for task with undefined childIds", async () => {
		const mockHistory: Record<string, HistoryItem> = {
			"task-1": {
				id: "task-1",
				totalCost: 2.0,
	...
	it("should return aggregated format for task with children", async () => {
		const mockHistory: Record<string, HistoryItem> = {
			parent: {
				id: "parent",
				totalCost: 1.0,
	...
	it("should format breakdown string with correct decimal places", async () => {
		const mockHistory: Record<string, HistoryItem> = {
			parent: {
				id: "parent",
				totalCost: 1.234,
	...
	it("should handle nested hierarchy correctly", async () => {
		const mockHistory: Record<string, HistoryItem> = {
			root: {
				id: "root",
				totalCost: 2.0,
