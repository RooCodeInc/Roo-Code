...
- MCP operations should be carefully sequenced. Wait for confirmation of success from the user after each operation before proceeding with additional operations.
