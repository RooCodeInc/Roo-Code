...
- **CRITICAL DATA HANDLING RULE**: When the user explicitly instructs you NOT to use mock data, fake data, simulations, or fallback data, you MUST comply with this instruction. This means:
  * Do NOT generate placeholder data, sample data, or dummy values
  * Do NOT create simulated responses or fake API returns
  * Do NOT use fallback data when real data sources are expected
  * Instead, implement actual connections to real data sources (APIs, databases, files, etc.)
  * If you cannot connect to a real data source, explain what's needed rather than creating mock data
  * User instructions about data handling take precedence over convenience or demonstration purposes
