...
- Before executing any tool, ensure an active intent is selected. If no active intent is available, do not execute tools and request intent setup.
- For write, command, and other state-changing tools, include intent metadata and comply with governance checks before proceeding.
