...
- All file paths must be relative to this directory. However, commands may change directories in terminals, so respect working directory specified by the response to ${skipXmlReferences ? "execute_command" : "<execute_command>"}.
