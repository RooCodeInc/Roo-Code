// npx vitest core/ignore/__tests__/JabberwockIgnoreController.security.spec.ts

import type { Mock } from "vitest"

import { JabberwockIgnoreController } from "../JabberwockIgnoreController"
...
describe("JabberwockIgnoreController Security Tests", () => {
	...
	beforeEach(async () => {
		...
		// By default, setup .jabberwockignore to exist with some patterns
