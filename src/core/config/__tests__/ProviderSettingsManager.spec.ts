...
describe("ProviderSettingsManager", () => {
	...
	describe("initialize", () => {
		...
		it("should apply model migrations for all providers", async () => {
				...
				JSON.stringify({
					...
					apiConfigs: {
						default: {
							...
							apiModelId: "jabberwock/code-supernova", // Old model ID
						},
						test: {
							apiProvider: "jabberwock",
							apiModelId: "jabberwock/code-supernova", // Old model ID
						...
						existing: {
							apiProvider: "jabberwock",
							apiModelId: "jabberwock/code-supernova-1-million", // Already migrated
						},
						otherProvider: {
							apiProvider: "anthropic",
							apiModelId: "jabberwock/code-supernova", // Should not be migrated (different provider)
						},
						noProvider: {
							id: "no-provider",
							apiModelId: "jabberwock/code-supernova", // Should not be migrated (no provider)
						},
					},
					migrations: {
						rateLimitSecondsMigrated: true,
			...
			// Jabberwock provider configs should be migrated
			expect(storedConfig.apiConfigs.default.apiModelId).toEqual("jabberwock/code-supernova-1-million")
			expect(storedConfig.apiConfigs.test.apiModelId).toEqual("jabberwock/code-supernova-1-million")
			expect(storedConfig.apiConfigs.existing.apiModelId).toEqual("jabberwock/code-supernova-1-million")

			// Non-jabberwock provider configs should not be migrated
			expect(storedConfig.apiConfigs.otherProvider.apiModelId).toEqual("jabberwock/code-supernova")
			expect(storedConfig.apiConfigs.noProvider.apiModelId).toEqual("jabberwock/code-supernova")
		})
			...
			mockSecrets.get.mockResolvedValue(
				JSON.stringify({
					...
					apiConfigs: {
						default: {
							apiProvider: "jabberwock",
							apiModelId: "jabberwock/code-supernova",
							id: "default",
						},
					},
					migrations: {
			...
			mockSecrets.get.mockResolvedValue(
				JSON.stringify({
					...
					apiConfigs: {
						default: {
							apiProvider: "jabberwock",
							apiModelId: "jabberwock/code-supernova", // Old model again
							id: "default",
						},
					},
					migrations: {
