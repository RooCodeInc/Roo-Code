...
![3.44.1 Release - Parallel Tool Calling](/releases/3.44.1-release.png)

- Enable parallel tool calling with new_task isolation safeguards for improved performance (PR #10979 by @daniel-lxs)
