...
import type { ExtensionMessage, WebviewMessage, ClineAskResponse, ClineMessage, ClineAsk } from "@klaus-code/types"
...
/**
 * ExtensionClient is the main interface for interacting with the Klaus Code extension.
 *
 * Basic usage:
 * ```typescript
