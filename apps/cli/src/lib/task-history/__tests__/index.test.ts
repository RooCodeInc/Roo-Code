import { readTaskSessionsFromStoragePath } from "@jabberwock/core/cli"
...
vi.mock("@jabberwock/core/cli", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@jabberwock/core/cli")>()
	return {
		...actual,
