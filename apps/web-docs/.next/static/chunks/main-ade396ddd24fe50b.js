;(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	[792],
	{
		...
		512: (e, t, r) => {
			...
			let n = r(4007)._(r(3239)).default.createContext(null)
		},
		599: (e) => {
			!(function () {
				var t = {
		...
		1987: (e, t, r) => {
			...
			let n = r(4007)._(r(3239)).default.createContext({})
		},
		2004: (e, t, r) => {
			"use strict"
			Object.defineProperty(t, "__esModule", { value: !0 }),
		...
		2743: (e, t) => {
			...
			function r(e, t) {
				return (
					void 0 === t && (t = ""), ("/" === e ? "/index" : /^\/index(\/|$)/.test(e) ? "/index" + e : e) + t
				)
			}
			Object.defineProperty(t, "__esModule", { value: !0 }),
				Object.defineProperty(t, "default", {
		...
		2878: (e, t, r) => {
			"use strict"
			Object.defineProperty(t, "__esModule", { value: !0 }), r(8898)
			let n = r(3049)
			;(window.next = {
				version: n.version,
				get router() {
		...
		3123: (e, t, r) => {
			...
			function d(e) {
				...
				return (
					e || t.push((0, i.jsx)("meta", { name: "viewport", content: "width=device-width" }, "viewport")), t
				)
			}
			function p(e, t) {
		...
		5784: (e, t, r) => {
				...
				let {
					...
					d = (e) => {
						...
						return (function e(t, r, n) {
							...
							.then(
								(e) => (
									(u && "no-cache" !== e.response.headers.get("x-middleware-cache")) || delete r[f], e
								),
							)
							.catch((e) => {
								throw (
			...
			class z {
				...
				push(e, t, r) {
					return (
						void 0 === r && (r = {}), ({ url: e, as: t } = k(this, e, t)), this.change("pushState", e, t, r)
					)
				}
				replace(e, t, r) {
					return (
				...
				async getRouteInfo(e) {
					...
					try {
						...
						if (
							...
							t(),
							(null == j ? void 0 : null == (E = j.effect) ? void 0 : E.type) === "redirect-internal" ||
								(null == j ? void 0 : null == (y = j.effect) ? void 0 : y.type) === "redirect-external")
						)
							return j.effect
