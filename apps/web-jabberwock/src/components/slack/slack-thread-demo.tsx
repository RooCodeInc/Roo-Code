		...
		() => [
			{
				...
				body: (
					<span>
						We need to add a page to our Marketing site that highlights using Jabberwock from Slack.
					</span>
				),
			},
			{
			...
			},
			{
				...
				body: (
					<div className="space-y-3">
						<p>
							I&apos;ve created a comprehensive implementation plan for the Jabberwock Slack integration
							marketing page at{" "}
							<code className="rounded bg-white/10 px-1.5 py-0.5 text-[12px] text-[#F8F8F9]">
			...
			},
			{
				...
				body: (
					<div className="space-y-3">
						<p>
							I&apos;ve built the Jabberwock Slack integration marketing page. Here&apos;s what was
							implemented:
						</p>
