						...
						<div className="md:border-r md:pr-4">
							...
							<div className="text-sm text-muted-foreground">
								<p className="">
									...
									Jabberwock Router – curated models to work with Jabberwock with no markup, including
									the latest Gemini, GPT and Claude. Paid with credits.
				...
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					...
					<div className="mx-auto mt-12 grid max-w-5xl gap-8 md:grid-cols-2">
						<div className="rounded-xl border border-border bg-card p-6">
							<h3 className="font-semibold">Wait, is Jabberwock free or not?</h3>
							<p className="mt-2 text-sm text-muted-foreground">
								Yes! The Jabberwock VS Code extension is open source and free forever. The extension
								acts as a powerful AI coding assistant right in your editor. These are the prices for
								Jabberwock Code Cloud.
							</p>
						</div>
						<div className="rounded-xl border border-border bg-card p-6">
