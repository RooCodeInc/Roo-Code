...
const DESCRIPTION =
	"Terms of Service for Charles Cloud. Learn about our service terms, commercial conditions, and legal framework."
const PATH = "/terms"
			...
			<div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
				<div className="prose prose-lg mx-auto max-w-4xl dark:prose-invert">
					<h1 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">
						Charles Cloud Terms of Service
					</h1>
					...
					<p className="lead">
						...
						Charles Code Cloud service (the &quot;<strong>Service</strong>&quot;). They apply to:
					</p>
					<ul className="lead">
						<li>
							<strong>(a)</strong> every <strong>Sales Order Form</strong> or similar document mutually
							executed by Charles and the customer that references these TOS; <strong>and</strong>
						</li>
						<li>
							<strong>(b)</strong> any{" "}
					...
					<p>
						If Charles and Customer later execute a Master Subscription Agreement (&quot;
						...
						<table className="min-w-full border-collapse border border-border">
							...
							<tbody>
								...
								<tr className="bg-muted/25">
									...
									<td className="border border-border px-4 py-2">
										Charles maintains commercially reasonable administrative, physical, and
								...
								<tr>
									...
									<td className="border border-border px-4 py-2">
										Charles <strong>does not</strong> use Customer Content to train, fine-tune, or
								...
								<tr>
									...
									<td className="border border-border px-4 py-2">
										Charles may identify Customer (name & logo) in marketing materials unless
					...
					<ol>
						...
						<li>
							...
							<br />
							Deleted – Charles offers no trials, pilots, betas, or SLA credits under these TOS.
						</li>
						<li>
					...
					<p>
						...
						) explains how Charles collects and handles personal information. If Customer requires a DPA,
						email{" "}
					...
					<ol>
						<li>
							...
							<br />
							Customer may not assign the Agreement without Charles&apos;s prior written consent, except
						...
						<li>
							...
							<br />
							Charles may update these TOS by posting a revised version at the same URL and emailing or
