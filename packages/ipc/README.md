...
This package provides IPC functionality for Klaus Code, allowing external applications to communicate with the extension through a socket-based interface.
...
```typescript
import { IpcClient } from "@klaus-code/ipc"
