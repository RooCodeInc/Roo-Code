 ...
 * Optionally creates .orchestration/active_intents.yaml with a test intent.
 */
 ...
 * Pass the same path returned from setupTestWorkspace, or omit to clean last created.
 */
