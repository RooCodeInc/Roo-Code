...
;(global as any).DesignSystemProvider = ({ children }: { children: any }) =>
  children
...
// Alternative approach: Configure Testing Library with a custom wrapper
// that ensures React is properly initialized
const ReactWrapper = ({ children }: { children: React.ReactNode }) => {
  // This wrapper will be used by all tests
  return children
}
