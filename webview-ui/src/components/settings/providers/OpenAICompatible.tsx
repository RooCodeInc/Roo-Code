			...
			<div className="flex flex-col gap-3">
				...
				<div>
					<div className="flex items-center gap-1">
						<Checkbox
							checked={
								apiConfiguration?.openAiCustomModelInfo?.supportsInterleavedThinking ??
								openAiModelInfoSaneDefaults.supportsInterleavedThinking
							}
							onChange={handleInputChange("openAiCustomModelInfo", (checked) => {
								return {
									...(apiConfiguration?.openAiCustomModelInfo || openAiModelInfoSaneDefaults),
									supportsInterleavedThinking: checked,
								}
							})}>
							<span className="font-medium">
								{t("settings:providers.customModel.interleavedThinking.label")}
							</span>
						</Checkbox>
						<StandardTooltip content={t("settings:providers.customModel.interleavedThinking.description")}>
							<i
								className="codicon codicon-info text-vscode-descriptionForeground"
								style={{ fontSize: "12px" }}
							/>
