	...
	useAppTranslation: () => ({
		t: (key: string) => {
			const translations: Record<string, string> = {
				...
				"cloud:signIn": "Connect to Joe Code Cloud",
				"cloud:cloudBenefitsTitle": "Try Joe Code Cloud",
				...
				"cloud:visitCloudWebsite": "Visit Joe Code Cloud",
				"cloud:taskSync": "Task sync",
				"cloud:taskSyncDescription": "Sync your tasks for viewing and sharing on Joe Code Cloud",
				...
				"cloud:cloudUrlPillLabel": "Joe Code Cloud URL: ",
			}
...
describe("CloudView", () => {
	it("should display benefits when user is not authenticated", () => {
		...
		expect(screen.getByRole("heading", { name: "Try Joe Code Cloud" })).toBeInTheDocument()
	...
	it("should not display cloud URL pill when pointing to production", () => {
		...
		expect(screen.queryByText(/Joe Code Cloud URL:/)).not.toBeInTheDocument()
	})
