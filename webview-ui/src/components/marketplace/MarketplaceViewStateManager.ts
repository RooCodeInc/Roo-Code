 ...
 *
 * This class manages the state for the marketplace view in the s2sCopilot extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the s2sCopilot extensions interface
