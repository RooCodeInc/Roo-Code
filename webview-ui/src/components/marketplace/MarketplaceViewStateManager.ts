 ...
 *
 * This class manages the state for the marketplace view in the Joe Code extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the Joe Code extensions interface
