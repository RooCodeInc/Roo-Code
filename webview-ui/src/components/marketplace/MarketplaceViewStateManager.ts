 ...
 *
 * This class manages the state for the marketplace view in the Klaus Code extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the Klaus Code extensions interface
...
import { MarketplaceItem, MarketplaceInstalledMetadata } from "@klaus-code/types"
