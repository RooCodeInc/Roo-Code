	...
	(
		...
		return (
			<textarea
				...
				ref={textAreaRef}
				className={cn(
					"flex w-full rounded-xl ring-offset-background placeholder:text-muted-foreground focus:outline-0 focus-visible:outline-none focus-visible:border-vscode-focusBorder disabled:cursor-not-allowed disabled:opacity-50 scrollbar-hide",
