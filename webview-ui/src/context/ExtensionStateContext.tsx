...
export const ExtensionStateContextProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
	const [state, setState] = useState<ExtensionState>({
		...
		rpiVerificationStrictness: "lenient",
		sandboxImage: "node:20",
		sandboxNetworkAccess: "restricted",
		sandboxMemoryLimit: "4g",
		sandboxMaxExecutionTime: 120,
		rpiCodeReviewEnabled: true,
		rpiCodeReviewScoreThreshold: 4,
		rpiContextDistillationBudget: 8000,
		rpiCouncilTimeoutSeconds: 90,
